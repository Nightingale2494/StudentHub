    ...
    <div className="min-h-screen bg-[#0A0A0A] text-white flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center px-6 pb-16">
        <div className="w-full max-w-md">
          ...
          <p className="text-neutral-400 mb-8">Sign in to your StudentHub account.</p>
          ...
          <div className="mt-6 text-sm text-neutral-500">
            New to StudentHub?{" "}
            <Link to="/register" data-testid="login-register-link" className="text-[#0066FF] hover:underline">
              Create an account
            </Link>
          </div>
        </div>
